// components/checkout/LocationPicker.tsx
//
// Drop-in replacement for the free-text State + LGA inputs in CheckoutScreen.
//
// USAGE — replace the existing City/State row and LGA input with:
//
...
//   />
//
// The component writes plain string values to formData — identical to what
// the TextInputs were writing — so nothing else in your checkout flow changes.
