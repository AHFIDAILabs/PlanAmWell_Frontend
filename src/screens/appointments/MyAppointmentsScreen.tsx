...
const styles = StyleSheet.create({
  ...
  countdown: { fontSize: 14, color: "#F59E0B", fontWeight: "600", marginTop: 6 },
  ...
  statusText: { color: "#fff", fontSize: 13, fontWeight: "700", letterSpacing: 0.5 },
  joinButton: { flex: 1, backgroundColor: "#10B981", paddingVertical: 13, paddingHorizontal: 16, borderRadius: 12, alignItems: "center", justifyContent: "center", minHeight: 48 },
