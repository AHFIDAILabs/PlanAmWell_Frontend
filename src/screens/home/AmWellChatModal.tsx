...
return (
        <SafeAreaView style={styles.fullScreen} edges={['top', 'left', 'right']}>
            ...
            <KeyboardAvoidingView 
                ...
                keyboardVerticalOffset={Platform.OS === "ios" ? 90 : 0} // Increased for iOS to keep input visible
            >
                <FlatList
                    ref={flatListRef}
                    data={messages}
                ...
                {/* 3. Input Area: Recording Indicator is now strictly pinned here */}
...
const styles = StyleSheet.create({
    ...
    userBubble: { alignSelf: 'flex-end', backgroundColor: '#D81E5B', borderBottomRightRadius: 5 },
    botBubble: { alignSelf: 'flex-start', backgroundColor: '#F5F5F5', borderBottomLeftRadius: 5 },
